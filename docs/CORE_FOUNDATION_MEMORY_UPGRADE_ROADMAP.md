# Aionis Core Foundation Memory Upgrade Roadmap

Last reviewed: 2026-04-16

Historical status: archive roadmap reference
...
This document turns the earlier Aionis Core foundation-memory direction into an execution roadmap snapshot.
...
That is the clearest path to a local runtime that remains flexible enough to store general context while becoming much better at helping agents remember how work gets done.
