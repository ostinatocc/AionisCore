...
Current release line: `0.2.31` for the Aionis Lite Developer Preview.
...
npx @ostinato/aionis-runtime@latest codex release 0.2.31 --summary "0.2.31 published and verified."
...
npm exec --yes --package @ostinato/aionis-runtime@0.2.31 --cache /tmp/aionis-fresh-npm-exec --prefer-online -- aionis-runtime --version
```
