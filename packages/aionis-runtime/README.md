...
Current release line: `0.2.32` for the Aionis Lite Developer Preview.
...
npx @ostinato/aionis-runtime@latest codex release 0.2.32 --summary "0.2.32 published and verified."
...
npm exec --yes --package @ostinato/aionis-runtime@0.2.32 --cache /tmp/aionis-fresh-npm-exec --prefer-online -- aionis-runtime --version
```
